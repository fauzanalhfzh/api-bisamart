...
-- AddForeignKey
ALTER TABLE "_category_product" ADD CONSTRAINT "_category_product_A_fkey" FOREIGN KEY ("A") REFERENCES "categories"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_category_product" ADD CONSTRAINT "_category_product_B_fkey" FOREIGN KEY ("B") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE;
